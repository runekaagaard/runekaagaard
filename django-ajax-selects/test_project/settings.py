...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_ajax_selects',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wx&e&5cgb0n9_mia=osmhqdof^k58baao5=83bvsq!mxiec8+*'
...
TEMPLATE_DIRS = (
    os.path.realpath(DIR + '/../ajax_select/templates'),
